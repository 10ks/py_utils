...
# 160x120 320x240 640x480 800x600 1280x720
...
vc.set(cv2.CAP_PROP_FRAME_WIDTH, 800) # set the Horizontal resolution
vc.set(cv2.CAP_PROP_FRAME_HEIGHT, 600) # Set the Vertical resolution
